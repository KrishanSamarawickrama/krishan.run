...
export function ProfileHero() {
  ...
  return (
    <div className="mb-8">
      ...
      {/* Experience + Education Boxes */}
      <div className="flex flex-col lg:flex-row gap-5 mb-10">
        {/* Experience Box */}
        <div className="flex-[2] border border-[var(--accent)]/50 rounded px-6 py-5">
        ...
        {/* Education Box */}
        <div className="flex-[1] border border-[var(--accent)]/50 rounded px-6 py-5">
          <div className="text-[var(--accent)] font-bold mb-4 text-glow-sm flex items-center gap-2">
